...
<body>
    ...
    <main>
        ...
        <p class="pgf">Para calcular seu IMC faça login ou <a class="cdt" href="cadastro.php">Cadastre-se</a></p>
        <p class="pgf">OU</p>
        <p class="pgf">Acesse como <a class="cdt" href="login_adm.php">Administrador</a></p>
        
        <form action="login_bd2.php" method="POST">
            <label for="email">
                <span>E-mail</span>
